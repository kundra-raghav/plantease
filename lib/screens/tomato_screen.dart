            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/tomatoplant.png'),
                      _buildImage('assets/images/tomatoleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about Tomato and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/tomatoleaf.png', 0),
          _buildImageThumbnail('assets/images/tomato_icon.png', 1),
        ],
      ),
    );
  }
