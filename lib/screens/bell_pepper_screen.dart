...
class bellpepperScreen extends StatefulWidget {
  @override
  _bellpepperScreenState createState() => _bellpepperScreenState();
}

class _bellpepperScreenState extends State<bellpepperScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/bellpepperplant.png'),
                      _buildImage('assets/images/bellpepperleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about Bellpepper and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/bellpepperleaf.png', 0),
          _buildImageThumbnail('assets/images/bellpepper_icon.png', 1),
        ],
      ),
    );
  }
