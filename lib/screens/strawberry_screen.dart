...
class StrawberryScreen extends StatefulWidget {
  @override
  _StrawberryScreenState createState() => _StrawberryScreenState();
}
...
class _StrawberryScreenState extends State<StrawberryScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/strawberryplant.png'),
                      _buildImage('assets/images/strawberryleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about Strawberry and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/strawberryleaf.png', 0),
          _buildImageThumbnail('assets/images/strawberry_icon.png', 1),
        ],
      ),
    );
  }
  ...
  Widget _buildImageThumbnail(String imagePath, int index) {
    print('Thumbnail Image Path: $imagePath');
