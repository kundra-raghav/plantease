            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/cornplant.png'),
                      _buildImage('assets/images/cornleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about corn and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/cornleaf.png', 0),
          _buildImageThumbnail('assets/images/corn_icon.png', 1),
        ],
      ),
    );
  }
