...
class SquashScreen extends StatefulWidget {
  @override
  _SquashScreenState createState() => _SquashScreenState();
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/squashplant.png'),
                      _buildImage('assets/images/squashleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about Squash and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/squashleaf.png', 0),
          _buildImageThumbnail('assets/images/squash_icon.png', 1),
        ],
      ),
    );
  }
