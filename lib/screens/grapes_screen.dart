            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/grapesplant.png'),
                      _buildImage('assets/images/grapesleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about grapes and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/grapesleaf.png', 0),
          _buildImageThumbnail('assets/images/grapes_icon.jpg', 1),
        ],
      ),
    );
  }
