...
class cherryScreen extends StatefulWidget {
  @override
  _cherryScreenState createState() => _cherryScreenState();
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/cheeryplant.png'),
                      _buildImage('assets/images/cheeryleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about Apple and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/cheeryleaf.png', 0),
          _buildImageThumbnail('assets/images/cherry_icon.jpg', 1),
        ],
      ),
    );
  }
