            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/appleplant.png'),
                      _buildImage('assets/images/appleleaf.png'),
                    ],
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/appleleaf.png', 0),
          _buildImageThumbnail('assets/images/apple_icon.png', 1),
        ],
      ),
    );
  }
