            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  CarouselSlider(
                    items: [
                      _buildImage('assets/images/orangeplant.png'),
                      _buildImage('assets/images/orangeleaf.png'),
                    ],
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Description about orange and its diseases.',
  ...
  Widget _buildImageSelector() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildImageThumbnail('assets/images/orangeleaf.png', 0),
          _buildImageThumbnail('assets/images/orange_icon.png', 1),
        ],
      ),
    );
  }
